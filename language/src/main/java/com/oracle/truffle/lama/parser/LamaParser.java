...
public class LamaParser extends Parser {
	...
	public final FunctionBodyContext functionBody() throws RecognitionException {
		...
		try {
			...
			setState(202);
			scopeDefinitions();
			 ((FunctionBodyContext)_localctx).result =  ScopedExprsGen.of(); 
			setState(207);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8875272386647424L) != 0)) {
		...
		try {
			...
			case 1:
				...
				((ExpressionContext)_localctx).basicExpression = basicExpression(0);
				 ((ExpressionContext)_localctx).result =  GenInterfaces.of(((ExpressionContext)_localctx).basicExpression.result)::generate; 
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				...
				((ExpressionContext)_localctx).expression = expression();
				 ((ExpressionContext)_localctx).result =  GenInterfaces.concat(GenInterface.konst(_localctx.result, ValueCategory.Val), ((ExpressionContext)_localctx).expression.result)::generate; 
				}
				break;
			}
		}
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8875272386647424L) != 0)) {
				...
				((ArrayExpressionContext)_localctx).expression = expression();
				 vals = GenInterfaces.add(vals, GenInterface.konst(factory.finishSeq(((ArrayExpressionContext)_localctx).expression.result), ValueCategory.Val))::generate; 
				setState(450);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__4) {
		...
		try {
			...
			case 1:
				...
				((SExpressionContext)_localctx).expression = expression();
				 vals = GenInterfaces.add(vals, GenInterface.konst(factory.finishSeq(((SExpressionContext)_localctx).expression.result), ValueCategory.Val))::generate; 
				setState(469);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__4) {
		...
		try {
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8875272386647424L) != 0)) {
				...
				((ListExpressionContext)_localctx).expression = expression();
				 vals = GenInterfaces.add(vals, GenInterface.konst(factory.finishSeq(((ListExpressionContext)_localctx).expression.result), ValueCategory.Val))::generate; 
				setState(488);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__4) {
	...
	public final CaseBranchContext caseBranch() throws RecognitionException {
		...
		try {
			...
			((CaseBranchContext)_localctx).scopeExpression = scopeExpression();
			 ((CaseBranchContext)_localctx).returns =  factory.finishBlock(GenInterfaces.of(((CaseBranchContext)_localctx).scopeExpression.result)::generate); 
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final EtaExpressionContext etaExpression() throws RecognitionException {
		...
		try {
			...
			((EtaExpressionContext)_localctx).basicExpression = basicExpression(0);
			      ...
			      var fun = factory.finishFunction(GenInterfaces.of(factory.createCall(func, params, ((EtaExpressionContext)_localctx).t))::generate).instantiate();
