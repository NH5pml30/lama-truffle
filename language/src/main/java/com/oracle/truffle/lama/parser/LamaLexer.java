...
public class LamaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "T__34", "T__35", "T__36", "WS", "COMMENT", "LINE_COMMENT", 
			"ULETTER", "LLETTER", "LETTER", "DIGIT", "STRING_CHAR", "CHAR_CHAR", 
			"OP_CHAR", "UIDENT", "LIDENT", "DECIMAL", "STRING", "CHAR", "OP"
		};
	}
